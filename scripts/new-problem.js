...
- **idea_summary**: <!-- 풀이의 핵심 아이디어와 문제에 접근한 방식을 요약하여 작성하세요. (예: 각 수포자의 점수를 계산한 후, 가장 높은 점수를 받은 사람을 찾아 배열에 담아 반환) -->
- **next_hint**: <!-- 문제 풀이 과정에서 고민했던 점이나 다른 접근 방식에 대한 생각을 작성하세요. (예: 효율성을 더 높일 수 있는 방법, 엣지 케이스 처리, 다른 구현 방식과의 비교) -->
`;
